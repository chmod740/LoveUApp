...
public class ArcMenu extends ViewGroup implements OnClickListener
{
            ...
            for (int i = 0; i < count - 1; i++)
            {
                ...
                if(i<3){
                    cl = (int) (mRadius * Math.sin(Math.PI/ (count - 4)
                            * i));
                    ct = (int) (mRadius * Math.cos(Math.PI/ (count - 4)
                            * i));
                }else{
                    cl = (int) (mRadius * Math.sin(Math.PI/ (count - 4)
                            * i));
                ...
                int x=(getMeasuredWidth()- cWidth)/2;
                int y=(getMeasuredHeight()- cHeight)/2;

                //Log.e(TAG, cl + " , " + ct);
                child.layout(cl+x, ct+y, cl+x + cWidth, ct+y + cHeight);
    ...
    public void toggleMenu(int durationMillis)
    {
        ...
        for (int i = 0; i < count - 1; i++)
        {
            ...
            if(i<3){
                // child left
                cl = (int) (mRadius * Math.sin(Math.PI / (count - 4) * i));
                // child top
                ct = (int) (mRadius * Math.cos(Math.PI  / (count - 4) * i));
            }else {
                // child left
                cl = (int) (mRadius * Math.sin(Math.PI / (count - 4) * i));
                // child top
