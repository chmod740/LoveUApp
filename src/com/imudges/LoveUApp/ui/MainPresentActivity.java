...
public class MainPresentActivity extends FragmentActivity {
    ...
    private void initMain() {
        ...
        mFragments[4] = fragmentManager.findFragmentById(R.id.present_top_fragment1);
        mFragments[5] = fragmentManager.findFragmentById(R.id.present_top_fragment3);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (keyCode == KeyEvent.KEYCODE_MENU) {
            startActivity(new Intent(MainPresentActivity.this,MainSetActivity.class));
        ...
        if(key==false){
            Toast.makeText(MainPresentActivity.this, "(>ˍ<) ～您真的想要离开吗?", Toast.LENGTH_LONG).show();
            key=true;
            return true;
        }
        return super.onKeyDown(keyCode, event);
